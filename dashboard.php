...
$navbar_links = "investor-navbar-links.php";
  ...
  <div style="width: 1100px; margin: 0 auto;">
    ...
    <div id="dashboard">
      <div class="row top" style="border-style: solid;vertical-align:middle;">
        <h2 style="display:inline;">Account Value $97,567.78</h2><span style="float:right;color:#4e90cd;font-size:110%;padding-top:7px;"><a href="#"><span class="glyphicon glyphicon-plus-sign"></span> Add Funds</a></span>
      </div>
      <div class="row" style="border-style: none solid; display:flex;">
        ...
        <div class="col-md-7 details">
          <div class="row">
            Available Balance:<span style="float:right;">$68,000.98</span>
          </div>
          <div class="row" style="border-top-style: solid;">
            Amount Invested:<span style="float:right;">$12,222.00</span>
          </div>
          <div class="row" style="border-top-style: solid;">
            Outstanding Principal:<span style="float:right;">$21,222.00</span>
          </div>
          <div class="row" style="border-top-style: solid;">
      ...
      <div class="row bottom" style="border-style: solid;display:flex;">
        <div class="col-md-4" style="border-right-style: solid;">
          ...
          <span id="auto-invest-status">OFF</span>
